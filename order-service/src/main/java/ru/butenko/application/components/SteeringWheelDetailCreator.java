...
public class SteeringWheelDetailCreator extends BaseDetailCreator {
    public SteeringWheelDetailCreator(BaseRepository<UUID, ComponentOption> repository) {
        super(repository);
    }

    @Override
    public ComponentType supportedType() {
        return ComponentType.STEERING_WHEEL;
    }
}
